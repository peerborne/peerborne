> Exploratory design note: the goals below are proposals, not implemented capability claims. See [the feature audit](../docs/feature-audit.md) for current evidence.

# Peerborne document store goals
