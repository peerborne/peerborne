...
| Capability hierarchy and field capabilities | Verified | Standalone capability suite | The document mutation path does not enforce field capabilities. |
