...
| `DOCUMENT_PUBLISH_PATH` | Legacy relay topic identifier; current `PeerborneNode` does not subscribe because V1 cannot authorize pin requests | `/peerborne/documents/v3` |
...
```toml
[env]
  TOPIC_ALLOWLIST  = "/peerborne/document/v3/,/peerborne/documents/v3,/document/,/documents"
  MAX_AUTO_TOPICS  = "500"
