...
- `yarn test:e2e` builds and smoke-tests all four browser examples.
...
- [`examples/peerborne-note`](https://github.com/Peerborne/peerborne/tree/main/examples/peerborne-note)
  is the bounded initial-release Automerge invitation demo. Read its
  [identity, relay, and recovery boundaries](../../cookbook/peerborne-note/)
  before trying it with another browser.
...
- [Peerborne Note](../../cookbook/peerborne-note/) — try the initial-release demo and review its boundaries
