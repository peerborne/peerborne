...
The 2026-09-10 dependency revalidation found `snarkjs` 0.7.6 as the current
release and confirmed that its pinned
[`COPYING`](https://github.com/iden3/snarkjs/blob/v0.7.6/COPYING) file declares
GPL-3.0. That metadata is not by itself a conclusion about compatibility with a
particular integration or distribution model. Any future proposal must pass an
explicit, qualified license review before selecting or distributing the
dependency.
...
11. How would the pinned dependency's license obligations apply to the exact
    integration, bundling, generated artifacts, and distribution model, and
    has that model passed qualified license review?
...
- [`snarkjs` 0.7.6](https://github.com/iden3/snarkjs/tree/v0.7.6)
- [`snarkjs` 0.7.6 license](https://github.com/iden3/snarkjs/blob/v0.7.6/COPYING)
